create database if not exists P1327;
use P1327;
...
select p.product_name, sum(o.unit) as cnt
from Orders o, Products p
where o.order_date like '2020-02%' and o.product_id = p.product_id
group by p.product_name
having cnt >= 100;

select t.product_name, t.cnt as unit
from (select p.product_name, sum(o.unit) as cnt
      from Orders o, Products p
      where o.order_date like '2020-02%' and o.product_id = p.product_id
      group by p.product_name
      having cnt >= 100) as t;