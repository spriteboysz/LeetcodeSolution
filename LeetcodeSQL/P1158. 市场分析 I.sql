create database if not exists P1158;
use P1158;
...
select u.user_id as buyer_id, u.join_date, ifnull(t.cnt, 0) orders_in_2019
from Users u
         left join (select buyer_id, count(*) cnt from Orders where year(order_date) = '2019' group by buyer_id) t
